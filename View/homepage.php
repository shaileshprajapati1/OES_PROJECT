	...
	<div class="container">
		<div class="welcome-grids">
			<div class="col-md-6 welcome-w3right">
				<img src="<?php echo $this->URL; ?>images/welcome.jpg" class="img-responsive" alt="" />
	...
	<div class="container">
		...
		<div class="readmore-w3">
			<ul>
				...
				<!-- <li><a class="readmore" href="register"  data-toggle="modal" data-target="#myModal3">Register</a></li> -->
			</ul>
			<!-- <ul>
					...
					<div class="banner-wrap">
						<div class="col-md-4 client-grids">
							...
							<div class="col-md-5 c-img">
								<img src="<?php echo $this->URL; ?>images/c1.jpg" alt="" />
							</div>
						...
						<div class="col-md-4 client-grids">
							<p>In vitae tincidunt turpis. Proin in euismod dolor. Sed eget tellus venenatis, molestie lorem tempus, viverra ante vulputate.</p>
							<div class="col-md-5 c-img">
								<img src="<?php echo $this->URL; ?>images/c2.jpg" alt="" />
							</div>
							<div class="col-md-7 c-info">
								<h4>Charlize</h4>
								<h5>student2</h5>
						...
						<div class="col-md-4 client-grids">
							<p>In vitae tincidunt turpis. Proin in euismod dolor. Sed eget tellus venenatis, molestie lorem tempus, viverra ante vulputate.</p>
							<div class="col-md-5 c-img">
								<img src="<?php echo $this->URL; ?>images/c3.jpg" alt="" />
							</div>
							<div class="col-md-7 c-info">
								<h4>Jessica</h4>
								<h5>student3</h5>
				...
				<article style="position: absolute; width: 100%; opacity: 0;">
					<div class="banner-wrap">
						<div class="col-md-4 client-grids">
							<p>In vitae tincidunt turpis. Proin in euismod dolor. Sed eget tellus venenatis, molestie lorem tempus, viverra ante vulputate.</p>
							<div class="col-md-5 c-img">
								<img src="<?php echo $this->URL; ?>images/c4.jpg" alt="" />
							</div>
							<div class="col-md-7 c-info">
								<h4>Daniel</h4>
								<h5>student4</h5>
						...
						<div class="col-md-4 client-grids">
							<p>In vitae tincidunt turpis. Proin in euismod dolor. Sed eget tellus venenatis, molestie lorem tempus, viverra ante vulputate.</p>
							<div class="col-md-5 c-img">
								<img src="<?php echo $this->URL; ?>images/c5.jpg" alt="" />
							</div>
							<div class="col-md-7 c-info">
								<h4>Johnson</h4>
								<h5>student5</h5>
						...
						<div class="col-md-4 client-grids">
							<p>In vitae tincidunt turpis. Proin in euismod dolor. Sed eget tellus venenatis, molestie lorem tempus, viverra ante vulputate.</p>
							<div class="col-md-5 c-img">
								<img src="<?php echo $this->URL; ?>images/c6.jpg" alt="" />
							</div>
							<div class="col-md-7 c-info">
								<h4>Scarllet</h4>
								<h5>student6</h5>
